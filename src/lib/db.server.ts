...
export type DbKey = 'properties' | 'tenants' | 'payments' | 'contracts' | 'tickets' | 'notifications' | 'inspections' | 'chartData' | 'occupancyData' | 'paymentStatusData' | 'user' | 'users' | 'notices' | 'payment_logs' | 'rent_reminders';
